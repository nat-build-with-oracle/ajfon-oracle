...
.jp-InputArea-editor, .highlight, div.highlight { border-radius: 12px !important; overflow-x: auto !important; }
.highlight pre, .jp-OutputArea-output pre { white-space: pre !important; }
...
n = 0
for f in glob.glob('html/ch*.html'):
    h = open(f).read()
